...
5. Add dealership legal details, currency/tax policy, actual vehicle media uploads, notification delivery, and any pending/cancelled sale lifecycle the project needs. Current new sales complete immediately; pending/cancelled badge and filter styles are prepared.

...
class Database:
    ...
    def connection(self):
        ...
        try:
            ...
            raise PersistenceError('A unique value is already in use or a related record is invalid.') from exc
        except mysql.connector.Error as exc:
            logging.getLogger(__name__).error('Database operation failed (code %s)',exc.errno)
            raise DatabaseUnavailable('Database unavailable. Please try again shortly.') from exc
